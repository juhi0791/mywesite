  ...
  return (
    <>
      <div className="project-wrapper vertical-timeline-element--work">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 319"><path fill="#0099ff" fill-opacity="1" d="M0,224L24,218.7C48,213,96,203,144,197.3C192,192,240,192,288,160C336,128,384,64,432,42.7C480,21,528,43,576,53.3C624,64,672,64,720,69.3C768,75,816,85,864,106.7C912,128,960,160,1008,154.7C1056,149,1104,107,1152,90.7C1200,75,1248,85,1296,128C1344,171,1392,245,1416,282.7L1440,320L1440,0L1416,0C1392,0,1344,0,1296,0C1248,0,1200,0,1152,0C1104,0,1056,0,1008,0C960,0,912,0,864,0C816,0,768,0,720,0C672,0,624,0,576,0C528,0,480,0,432,0C384,0,336,0,288,0C240,0,192,0,144,0C96,0,48,0,24,0L0,0Z"></path></svg>
    </>
  );
};
